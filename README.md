...
<p align="center">
  <img src="docs/screenshots/map.png" alt="지도 화면 — 플로어플랜 위 부스 오버레이, 부스 상세, 경로 오버레이" width="640" />
</p>
...
COEX Hall A·B1 도면(SVG) 위에 부스를 오버레이한 핵심 지도입니다.
...
- **경로 추천** — 찜한 부스들을 입구(A/B)에서 시작하는 최적 방문 순서로 이어 A\* 기반 경로를 그리고 번호 뱃지 표시.
- **존 범례** — 일반/특별전시/독자만남홀/책마을/특별구역 색상 안내.

> **📌 관람 계획서 내보내기 — 이 앱의 핵심 기능**
>
> - **PDF 저장** — 경로가 그려진 지도 + Hall A·B 부스 번호표 + 찜 목록(이벤트 시간·부스별 방문 메모 포함)을 여러 페이지 PDF로 저장. 현장에서 오프라인으로 동선을 확인할 수 있습니다.
> - **이미지(PNG) 저장** — 경로·번호 뱃지가 표시된 도면 전체를 PNG 한 장으로 저장해 바로 공유.

### 인기 — `/popular`

<p align="center">
  <img src="docs/screenshots/popular.png" alt="인기 순위 화면" width="560" />
</p>
...
<p align="center">
  <img src="docs/screenshots/route.png" alt="찜 내역 / 동선 화면" width="560" />
</p>
...
<p align="center">
  <img src="docs/screenshots/reviews.png" alt="후기 화면" width="560" />
</p>
...
<p align="center">
  <img src="docs/screenshots/info.png" alt="행사 정보 화면" width="560" />
</p>
...
<p align="center">
  <img src="docs/screenshots/map-mobile.png" alt="모바일 지도" width="200" />
  &nbsp;&nbsp;
  <img src="docs/screenshots/reviews-mobile.png" alt="모바일 후기" width="200" />
</p>
